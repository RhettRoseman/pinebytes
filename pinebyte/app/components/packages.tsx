...
export default function PackagesComp() {
  const packages = [
    ...
    { name: "Premium Package", price: "$4,000", features: ["Custom Website (More than 7 pages) and/or Custom App", "3 x 1-minute videos", "Comprehensive strategy session", "25+ day delivery", "Extra revisions", "Ongoing support"], highlight: false },
  ];
