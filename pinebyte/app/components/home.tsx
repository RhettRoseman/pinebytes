...
const features: Feature[] = [
  {
    title: "🎯 Story-First Video That Converts",
    description:
      "We don’t just cut clips—we shape stories. Every edit is built to feel natural, human, and believable so your audience actually trusts what they’re watching."
  },
  {
    title: "⚡ Fast Turnaround Without Soulless Automation",
    description:
      "We use tools to move fast—but every video is reviewed, paced, and refined by a real editor. No template sludge. No robotic timing."
  },
  {
    title: "💵 Clear Pricing. Real Value.",
    description:
      "No hidden fees or vague promises. You know exactly what you’re paying for—and you get content that reflects your brand, not a recycled AI preset."
  },
  {
    title: "🤝 A Real Partner, Not a File Drop",
    description:
      "We collaborate, revise, and refine. That means feedback, white-label delivery if needed, and videos you’re proud to put your name on."
  }
];
...
const FeatureCard: React.FC<Feature> = ({ title, description }) => (
  <div className="bg-white p-10 rounded-lg shadow-md flex flex-col justify-center mt-1">
    ...
    <p className="text-gray-600 text-sm mr-2 ml-2">{description}</p>
  </div>
);
  ...
  return (
    <main className="bg-white text-gray-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url(/videoeditsoftware.jpg)",
      ...
      >
        <div className="bg-white bg-opacity-90 p-6 rounded-lg max-w-3xl">
          ...
          <p className="text-lg md:text-l text-gray-700">
            At <span className="text-green-700">PineByteDigital</span>, we help businesses stand out in a world flooded with AI-generated video by crafting content that feels real, natural, and trustworthy.
          </p>

          <p className="text-lg md:text-l text-gray-700">
            We use modern tools to move fast—but every story, every cut, and every beat is shaped by a human editor who understands pacing, emotion, and attention.
          </p>
        </div>
      ...
      <section className="py-20 px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold text-green-900">
            Why Most AI Video Content Falls Flat
          </h2>
          <p className="text-lg text-gray-700">
            People don’t hate AI. They hate knowing instantly when something feels fake.
          </p>
          <p className="text-lg text-gray-700">
            AI-only videos tend to look perfect—but sound empty. The pacing is off. The tone feels generic. And trust disappears before the message ever lands.
          </p>
          <p className="text-lg text-gray-700 font-semibold">
            We fix that by putting a human back in the process.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-8 text-center bg-green-900 text-white">
        ...
        <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
          Let’s build something real—content that actually sounds like you.
        </p>
        <Link
          href="/contact"
